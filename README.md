# multiGame is a Python program that so far has three game buttons; one for a number guessing game, one for a rock, paper, scissors game, and one for a fun fact quiz game. 
